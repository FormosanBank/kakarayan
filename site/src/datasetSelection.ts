...
export const DATASET_FIELD_INFO = [
  ...
  ["translations", "Sentence translations, attached only to their sentence", "句子翻譯，僅連結至所屬句子"],
  ["tokens", "Ordered surface token sequence", "依序排列的表層詞元"],
  ["phonology", "Available phonological tiers", "可用的音韻層級"],
  ["word_translations", "Word translations as owner-aligned JSON", "以詞為單位對齊的 JSON 翻譯"],
  ["morpheme_translations", "Morpheme translations as owner-aligned JSON", "以語素為單位對齊的 JSON 翻譯"],
