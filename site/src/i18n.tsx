...
const messages = {
  en: {
    ...
    "home.eyebrow": "FORMOSANBANK",
    "home.title": "Find words, sentences, and research data.",
    "home.lede":
      "Search the public FormosanBank corpora in your browser. No account or paid backend.",
    "home.search": "Search sentences",
    "home.learn": "Open dictionary",
    "home.collection": "Current release",
  ...
  "zh-Hant": {
    ...
    "common.source": "來源提交",
    "home.eyebrow": "FORMOSANBANK",
    "home.title": "查單詞、找例句、下載研究資料。",
    "home.lede":
      "直接在瀏覽器中搜尋公開 FormosanBank 語料庫，不需帳號或付費後端。",
    "home.search": "搜尋例句",
    "home.learn": "開啟單詞查詢",
    "home.collection": "目前版本",
    "explore.title": "探索語料庫",
